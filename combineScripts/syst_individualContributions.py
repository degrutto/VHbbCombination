...
for g in groups:
    if str('SFsdata') in g :
        ...
        print g
        os.system("combineTool.py -M ProfileLikelihood -m 125 --signif --pvalue -t -1 --expectSignal=1 vhbb_2016_13TeV_onlyrateParam.txt -n prefit%s   --job-mode lxbatch --task-name lxbatch_mdg_prefit%s  --sub-opts='-q 1nd -G CMS_CERN01_YODA'" % (str(g), str(g)) ) 
